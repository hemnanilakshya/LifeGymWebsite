<%@ Page Title="" Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="MChangepass.aspx.cs" Inherits="LifeGymWebsite.WebForm20" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                <link rel="stylesheet" href="./assets/css/forms.css" />

                <div class="custom-container-white">
                        <div class="form--container--white">
                                <div class="form--heading">Change Member Password</div>
