<%@ Page Title="" Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="MyDietChart.aspx.cs" Inherits="LifeGymWebsite.WebForm18" %>
        ...
        <div class="custom-container-white">
            <div class="form--container--white">
                ...
                <div class="form-row-4">
                    ...
                    <div class="form-group">
                        <label>Monday</label>
                        <asp:TextBox ID="txtmonday" runat="server" MaxLength="50" ReadOnly="True">
                        </asp:TextBox>
                        <p>
                    ...
                    <div class="form-group">
                        <label>Tuesday</label>
                        <asp:TextBox ID="txttue" runat="server" MaxLength="50" ReadOnly="True">
                        </asp:TextBox>
                        <p>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtwed" runat="server" MaxLength="50" ReadOnly="True"></asp:TextBox>
                        <p>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtthu" runat="server" MaxLength="50" ReadOnly="True">
                        </asp:TextBox>
                        <p>
                    ...
                    <div class="form-group">
                        <label>Friday</label>
                        <asp:TextBox ID="txtfri" runat="server" MaxLength="50" ReadOnly="True">
                        </asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtsat" runat="server" MaxLength="50" ReadOnly="True">
                        </asp:TextBox>
                        <p>
                    ...
                    <div class="form-group">
                        <label>Sunday</label>
                        <asp:TextBox ID="txtsun" runat="server" MaxLength="50" ReadOnly="True">
                        </asp:TextBox>
                        <p>
